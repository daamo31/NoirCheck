/**
 * Properly Accessible XION Modal
 * Implements Radix UI Dialog correctly with all required accessibility features
 */
...
export default function ProperXIONModal() {
  ...
  }, [abstraxionAccount?.isConnected, abstraxionAccount?.isConnecting, showModal, setShowModal]);
